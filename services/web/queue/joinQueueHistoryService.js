...
export const addQueueHistory = async(salonId, element, updatedByBarberEmail, updatedByBarberName) => {
...
export const addQueueHistoryWhenCanceled = async(salonId, canceledQueue, updatedByBarberEmail, updatedByBarberName) => {
