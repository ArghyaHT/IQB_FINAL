...
export const getDefaultSalonByAdmin = async (req, res, next) => {
    try {
        ...
        if (admin.salonId === 0) {
            ...
            const defaultLogo = [{
                "url": "https://res.cloudinary.com/dpynxkjfq/image/upload/v1743597098/iqb_borderless_ivi965.jpg"
              }]
...
export const sendVerificationCodeForAdminMobile = async (req, res, next) => {
    try {
        ...
        if(!user.mobileNumber){
            return ErrorHandler(ADMIN_MOBILE_NOT_EXIST_ERROR, ERROR_STATUS_CODE, res)
        }
