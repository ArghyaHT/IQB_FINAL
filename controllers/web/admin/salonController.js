...
import { ADMIN_NOT_EXIST_ERROR, EMAIL_NOT_FOUND_ERROR, IMAGE_FILE_EXTENSION_ERROR, IMAGE_FILE_SIZE_ERROR, NAME_LENGTH_ERROR } from "../../../constants/web/adminConstants.js";
import { SALON_ADDRESS_ERROR, SALON_ADDRESS_NOT_PRESENT_ERROR, SALON_BARBERS_FOUND_SUCCESS, SALON_CITY_ERROR, SALON_CONNECT_SUCCESS, SALON_CONTACT_TEL_ERROR, SALON_COORDINATES_ERROR, SALON_COUNTRY_ERROR, SALON_CREATE_SUCCESS, SALON_DELETE_SUCCESS, SALON_DESC_ERROR, SALON_DESC_NOT_PRESENT_ERROR, SALON_DESCRIPTION_EMPTY_SUCCESS, SALON_DESCRIPTION_RETRIEVED_SUCCESS, SALON_DESCRIPTION_UPDATE_SUCCESS, SALON_EMAIL_NOT_PRESENT_ERROR, SALON_EXISTS_ERROR, SALON_GALLERY_DELETE_ERROR, SALON_GALLERY_EMPTY_ERROR, SALON_GALLERY_NOT_FOUND_ERROR, SALON_GALLERY_UPLOADED_ERROR, SALON_IMAGE_DELETE_SUCESS, SALON_IMAGE_RETRIEVED_SUCESS, SALON_IMAGE_UPDATE_SUCESS, SALON_IMAGES_UPLOAD_SUCESS, SALON_INVALID_EMAIL_ERROR, SALON_LOGO_DELETE_ERROR, SALON_LOGO_NOT_FOUND_ERROR, SALON_LOGO_UPLOAD_SUCCESS, SALON_NAME_ERROR, SALON_NOT_CREATED_ERROR, SALON_NOT_FOUND_ERROR, SALON_OFFLINE_SUCCESS, SALON_ONLINE_SUCCESS, SALON_PAYMENTS_RETRIEVED_SUCCESS, SALON_POSTCODE_ERROR, SALON_POSTCODE_NOT_PRESENT_ERROR, SALON_QUEUELIST_ERROR, SALON_SERVICES_ERROR, SALON_SERVICES_RETRIEVED_SUCESS, SALON_TIMEZONE_ERROR, SALON_TRAIL_APPOINTMENT_ENABLED_ERROR, SALON_TRAIL_APPOINTMENT_ERROR, SALON_TRAIL_ENABLED_SUCCESS, SALON_TRAIL_QUEUE_ENABLED_ERROR, SALON_TRAIL_QUEUE_ERROR, SALON_TYPE_ERROR, SALON_UPDATE_SUCCESS, SALONID_EMPTY_ERROR, SALONS_RETRIEVED_SUCESS, SERVICE_DESC_ERROR, SERVICE_NAME_ERROR } from "../../../constants/web/SalonConstants.js";
      ...
      if (hasQueueing) {
        ...
        if (queueSubscription) {
          if (queueSubscription.trial === "Free") {
            return ErrorHandler(SALON_TRAIL_QUEUE_ERROR, ERROR_STATUS_CODE, res);
          }
          if (queueSubscription.trial === "Paid") {
            return ErrorHandler(SALON_TRAIL_QUEUE_ENABLED_ERROR, ERROR_STATUS_CODE, res);
          }
      ...
      if (hasAppointment) {
        ...
        if (appointmentSubscription) {
          if (appointmentSubscription.trial === "Free") {
            return ErrorHandler(SALON_TRAIL_APPOINTMENT_ERROR, ERROR_STATUS_CODE, res);
          }
          if (appointmentSubscription.trial === "Paid") {
            return ErrorHandler(SALON_TRAIL_APPOINTMENT_ENABLED_ERROR, ERROR_STATUS_CODE, res);
          }
