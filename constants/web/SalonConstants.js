...
export const SALON_COUNTRY_ERROR = "Please select country"
export const SALON_CITY_ERROR = "Please select city"
export const SALON_TIMEZONE_ERROR = "Please select timezone"
...
export const SALON_POSTCODE_ERROR = "Post code must be between 1 to 10 digits"
export const SALON_SERVICES_ERROR = "Please provide a service"
export const SALON_DESC_NOT_PRESENT_ERROR = "Please enter description"
export const SALON_ADDRESS_NOT_PRESENT_ERROR = "Please enter address"
export const SALON_POSTCODE_NOT_PRESENT_ERROR = "Please enter post code"
export const SALON_DESC_ERROR = "Salon description must be between 1 to 35 characters"
export const SALON_EXISTS_ERROR = "Salon name or email already exists"
...
export const SALON_TRAIL_QUEUE_ENABLED_ERROR ="A paid subscription for queue is already active, so the trial cannot be enabled."
export const SALON_TRAIL_APPOINTMENT_ENABLED_ERROR ="A paid subscription for appointment is already active, so the trial cannot be enabled."

export const SALON_TRAIL_QUEUE_ERROR = "The free trial for queueing has already been used and cannot be activated again."
export const SALON_TRAIL_APPOINTMENT_ERROR = "The free trial for appointment has already been used and cannot be activated again."
