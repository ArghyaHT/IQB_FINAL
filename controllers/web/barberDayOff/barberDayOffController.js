...
import { approveBarberDayOff, createBarberDayOff, getAllBarberDayoffRequests } from "../../../services/web/barberDayOff/barberDayOffService.js"
                ...
                <body>
                    <div class="container">
                        ...
                        <img src=${salon?.salonLogo[0]?.url} alt="Salon Logo">
                            ...
                            <h1 style="text-align: center;">Leave approved</h1>
                            <p>Dear ${barber.name},</p>
                            <p>Your leave has been approved on ${formattedDate}.</p>
