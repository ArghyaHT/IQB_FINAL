...
import { adminConnectKiosk, barberLoginKiosk, barberServedQueueTvApp, cancelQueueTvApp, changeBarberClockInStatus, changeBarberOnlineStatus, changeBarberOnlineStatusTV, changeMobileBookingAvailabilityOfSalon, changeSalonKioskStatus, changeSalonOnlineStatus, getAllAdvertisementsKiosk, getAllBarberbySalonId, getAllBarberbySalonIdKiosk, getAllSalonsByAdmin, getAllSalonServices, getAttendenceByBarberIdKiosk, getAvailableBarbersForQKiosk, getBarberByServicesKiosk, getBarberServicesByBarberIdKiosk, getDefaultSalon, getQueueListBySalonId, googleLoginTV, joinQueueKiosk, loginKiosk, salonAccountLogin } from "../../controllers/kiosk/kioskController.js";
...
router.route("/changeBarberOnlineStatusTV").post(changeBarberOnlineStatusTV)
